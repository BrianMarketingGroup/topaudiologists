...
export const metadata = {
  ...
  description: `Learn how ${siteConfig.name} connects patients and referring physicians with trusted audiology and hearing care practices — and how a listing puts your practice in front of those actively searching for care.`,
};
...
function Eyebrow({ children }: { children: React.ReactNode }) {
  return (
    <p className="inline-flex items-center gap-2.5 text-[11px] font-semibold tracking-[0.3em] uppercase text-teal-light mb-5">
      <span className="h-1.5 w-1.5 rotate-45 bg-teal-light shadow-[0_0_8px_2px_rgba(129, 140, 248,0.6)]" />
      {children}
    </p>
  );
}
...
const VALUES = [
  { icon: Activity, title: "Be Found at the Right Moment", body: "Patients search online before choosing a hearing care provider. A listing puts your practice in front of them exactly when they need you most." },
  { icon: ShieldCheck, title: "Built on Trust", body: "Hearing healthcare is highly personal. A professional profile helps patients feel confident selecting your practice before they ever call." },
  { icon: Star, title: "Stand Out in Your City", body: "Showcase your diagnostic services, hearing technology, clinical team, and patient-centered care — instead of blending into generic search results." },
];
...
const INCLUDED = [
  ...
  { icon: MapPin, title: "City Directory Placement", body: "Appear in the cities where patients are searching for hearing and balance care." },
        ...
        <Container className="relative">
          <FadeIn variant="luxe">
            <div className="max-w-3xl mx-auto text-center">
              <Eyebrow>The Audiologist Directory</Eyebrow>
              <h1 className="race-head text-4xl sm:text-5xl lg:text-6xl text-pearl mb-6 leading-[1.05] text-balance">
                The Trusted Place to Find <span className="race-head--accent">Hearing Care.</span>
              </h1>
              <p className="text-lg sm:text-xl text-pearl/70 leading-relaxed">
                {siteConfig.name} connects patients and referring physicians with trusted audiology and hearing care practices across the
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <FadeIn variant="luxe" delay={0.1}>
              <div className="space-y-5 text-muted leading-relaxed text-lg text-left sm:text-center">
                <p>
                  Choosing an audiologist is a serious health decision — one that affects quality of life,
                  communication, and long-term wellness. Patients rarely go with the
                  first result they find; they compare credentials, specialties, hearing technology, patient
                  education resources, and reputation.
                </p>
                <p>
                  We built {siteConfig.name} to make that decision easier on both sides. For patients,
                  it&apos;s a clear place to discover and compare hearing and balance care practices in their area. For
        ...
        <Container className="relative">
          <FadeIn variant="luxe">
            <div className="text-center mb-14 max-w-2xl mx-auto">
              ...
              <h2 className="race-head text-3xl sm:text-4xl text-pearl mb-4">Hearing Care Is Built on Trust</h2>
        ...
        <Container className="relative">
          <FadeIn variant="luxe">
            <div className="text-center mb-10 max-w-2xl mx-auto">
              ...
              <h2 className="race-head text-3xl sm:text-4xl text-pearl mb-4">From Hearing Aids to Balance Disorders</h2>
              <p className="text-muted text-lg">
                Whatever your clinical specialty, your profile helps patients find the hearing care they need.
              </p>
            </div>
          </FadeIn>
            ...
            <div className="relative overflow-hidden rounded-3xl border border-gold/20 bg-gradient-to-br from-navy to-navy-dark text-center px-6 py-16 sm:py-20">
              ...
              <div className="relative">
                ...
                <p className="text-muted max-w-xl mx-auto mb-8 text-lg">
                  Reserve your listing now and reach patients and referring physicians actively searching for hearing care in your city.
                </p>
