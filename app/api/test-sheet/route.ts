  ...
  if (webhookUrl) {
    try {
      const payload = JSON.stringify({
        ...
        cities: "Denver, CO", featuredCities: "Denver, CO",
        specialties: "Hearing Aids", keyStaff: "None",
        contactName: "Test User", email: "test@test.com",
        contactPhone: "(555) 000-0000", title: "Owner",
        awardShipping: "123 Test St, Denver, CO 80202",
        cardLast4: "****1234", cardExpiry: "12/26", nameOnCard: "Test User",
        billingAddress: "123 Test St, Denver, CO 80202",
