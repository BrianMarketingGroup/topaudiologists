...
export const metadata: Metadata = {
  ...
  description:
    `Get in touch with the ${siteConfig.name} team. Questions about listing your audiology practice? Our team is ready to help you claim your city before the ${siteConfig.directory.launch} launch.`,
};
        ...
        <Container className="relative">
          <div className="max-w-3xl">
            ...
            <p className="text-muted text-xl leading-relaxed">
              Questions about listing your audiology practice? Our team is ready
