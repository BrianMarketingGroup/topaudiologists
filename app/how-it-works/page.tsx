        ...
        <div className="max-w-3xl mx-auto">
          <FadeIn variant="luxe">
            ...
            <p className="text-muted text-lg mb-12">
              Getting your audiology practice listed is simple. Here&apos;s what to expect.
            </p>
          </FadeIn>
            ...
            {[
              {
                ...
                body: "Complete our online application with your practice details, city selections, audiology specialties, provider credentials, and preferred listing tier. The process takes about 10 minutes.",
              },
              {
                step: "02",
                title: "We Review and Build Your Profile",
                body: "Our team reviews your application, confirms your information, and publishes a polished audiology practice profile on " + siteConfig.name + ".",
              },
              {
                step: "03",
                title: "Patients Find Your Practice",
                body: "Your listing appears in our directory when patients and referring physicians search for audiologists in your city. Featured listings receive top placement and a highlighted badge.",
              },
          ...
          <FadeIn variant="luxe">
            ...
            <h2 className="race-head text-3xl font-light text-pearl mb-8">
              ...
              <span className="race-head--accent">hearing care</span>
            </h2>
          </FadeIn>
