      ...
      <Container className="relative">
        <FadeIn variant="luxe" className="max-w-3xl mx-auto">
          ...
          <Section title="1. Who We Are">
            <p>{siteConfig.name} is an online directory dedicated to connecting patients and referring physicians with trusted audiology and hearing care practices across the United States.</p>
            <p>This site is intended for business use by audiology practices and is not directed to consumers.</p>
          </Section>

          <Section title="2. Information We Collect">
            <p>We may collect the following categories of information:</p>
            <ul>
              <li><strong className="text-pearl">Practice Information:</strong> practice name, website, phone number, audiology specialties, city, and state</li>
