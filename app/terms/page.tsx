      ...
      <Container className="relative">
        <FadeIn variant="luxe" className="max-w-3xl mx-auto">
          ...
          <Section title="2. Eligibility">
            <p>Listings are available to U.S.-based licensed audiologists and audiology practices in good standing. By applying, you represent and warrant that your business meets this requirement and that you are authorized to act on its behalf.</p>
          </Section>
