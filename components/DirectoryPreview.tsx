...
const CALLOUTS: Record<View, { tone: "spot" | "navy"; icon: React.ReactNode; text: React.ReactNode }> = {
  ...
  profile: {
    tone: "navy",
    icon: <span className="text-pearl text-[10px] font-bold">★</span>,
    text: <><span className="text-pearl font-semibold">Profile Page</span> — Every listing gets a dedicated profile with audiology specialties, providers &amp; staff, {D.teamLabel.toLowerCase()}, patient reviews, contact details, and your {siteConfig.shortName} badge.</>,
  },
};
