...
const HEADLINE = ["Be", "the", "audiologist", "they"];
const ACCENT = "trust.";
...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <Image
        src={HERO_IMAGE}
        alt="Audiologist providing patient hearing care"
        fill
        priority
        sizes="100vw"
      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl px-5 sm:px-8">
        <div className="py-24 lg:py-28">
          <div className="max-w-2xl">
            ...
            >
              <span className="h-1.5 w-1.5 rotate-45 bg-teal-light shadow-[0_0_8px_2px_rgba(165, 180, 252,0.7)]" />
              National Audiologist Directory · {siteConfig.directory.launch}
            </motion.p>
