          ...
          <div className="space-y-1 pt-6 mt-6 border-t border-pearl-dark">
            <label className="flex items-start gap-3 cursor-pointer">
              ...
              <span className="text-sm text-muted leading-snug">
                I consent to being contacted by the TopAudiologists.com team regarding my listing, and agree to receive marketing communications via email or SMS. Reply STOP to opt out at any time. I also agree to the{" "}
