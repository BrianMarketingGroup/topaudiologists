...
export const topAudiologistsConfig: SiteConfig = {
  siteName: "TopAudiologists.com",
  brandTagline: "Get Listed — TopAudiologists.com",
  businessNoun: "audiology practice",
  ...
  listingFields: {
    peopleLabel: "Audiologist(s) / Provider(s)",
    bioMaxChars: 1500,
